...
int main()
{
    ...
    printf("Veuillez choisir le numero de votre choix\n\n");
    printf("1. Exemple donne dans le TP (n=20, Pmax=520kg, Vmax=3m3\n");
    printf("2. Tableau d'objets genere aleatoirement\n");
    printf("\t\t1 ou 2 -->");
    char c;
    scanf("%c",&c);
    if(c=='1')
    ...
    {
        printf("Veuillez donner le nombre d'objets : n == ");
        scanf("%d",&n);
        printf("Veuillez donner le volume maximal du camion en metre cube : Vmax == ");
        scanf("%d",&Vmax);
        Vmax = Vmax*100;//rendre toutes les valeurs entières
        printf("Veuillez donner la capacite maximale du camion en kg: Pmax == ");
        scanf("%d",&Pmax);
